    ...
    <main className='flex items-center flex-col my-20 text-black'>
        ...
        <div className='flex justify-center gap-10 mt-8 flex-wrap'>
            <div className='flex flex-col justify-center items-center text-center w-max'>
                <Image src={img1} alt='img1' className='w-40 lg:w-60 shadow-shadowRecommend'></Image>
                <div className=' mt-4'>
            ...
            <div className='flex flex-col justify-center items-center text-center w-max'>
                <Image src={img2} alt='img1' className='w-40 lg:w-60 shadow-shadowRecommend'></Image>
                <div className='mt-4'>
            ...
            <div className='flex flex-col justify-center items-center text-center w-max'>
                <Image src={img3} alt='img1' className='w-40 lg:w-60 shadow-shadowRecommend'></Image>
                <div className='mt-4'>
            ...
            <div className='flex flex-col justify-center items-center text-center w-max'>
                <Image src={img4} alt='img1' className='w-40 lg:w-60 shadow-shadowRecommend'></Image>
                <div className='mt-4'>
